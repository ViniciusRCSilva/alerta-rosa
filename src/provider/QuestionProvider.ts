  ...
  private questions: QuestionProps[] = [
    {
      id: 0,
      enunciation:
        'Você tem medo de expressar sua opinião, expressar seus sentimentos ou pedir algo que precisa?',
      categorie: 'yellow',
    },
    {
      id: 1,
    ...
    },
    {
      id: 2,
      enunciation:
        'Seu parceiro tenta controlar todos os detalhes do seu relacionamento?',
      categorie: 'yellow',
    },
    {
      id: 3,
    ...
    },
    {
      id: 11,
      enunciation:
        'Seu parceiro joga ou quebra as coisas quando está com raiva?',
      categorie: 'orange',
    },
    {
      id: 12,
    ...
    },
    {
      id: 15,
      enunciation:
        'Seu parceiro te pressiona a se envolver em atividades sexuais desconfortáveis?',
      categorie: 'red',
    },
    {
      id: 16,
    ...
    },
    {
      id: 24,
      enunciation:
        'Você acredita que o agressor tem consciência de que praticou um crime com a violência?',
      categorie: 'red',
    },
    {
      id: 25,
