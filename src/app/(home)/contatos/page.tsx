...
export default function Contacts() {
  return (
    ...
    >
      <div className="flex flex-col w-full items-center justify-center animate-screenOpacity p-2">
        <p className="text-4xl md:text-6xl font-semibold uppercase pb-10 pt-40 text-center lg:text-left w-full">
          Contatos
        </p>

        <div className="flex flex-col items-center lg:grid lg:grid-cols-2 w-full">
          <InfoContent
            name="MPPE"
